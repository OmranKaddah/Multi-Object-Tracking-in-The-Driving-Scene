    ...
    namespace tracking {
        ...
        public:
            ...
            /**
               ...
               */
            virtual void ProcessFrame(Resources::ConstPtr detections, int frame, int img_width, int img_height)=0;
            ...
            /**
               * @brief Projects 3D box to the image. Once no part of 3D box is visible anymore, terminates the track
               * @author Omran (kaddah.omran@gmail.com)
               */
            void CheckExitTo2DProjeciton(const SUN::utils::Camera &camera, int current_frame, int &img_width, int &img_height);
