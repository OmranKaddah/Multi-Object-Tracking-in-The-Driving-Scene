...
namespace SUN {
    namespace utils {
        namespace visualization {
            ...
            void DrawDots(const Eigen::Vector3d &p1, const SUN::utils::Camera &camera, cv::Mat &ref_image, const cv::Scalar &color, int thickness=1, int line_type=1, const cv::Point2i &offset=cv::Point2i(0,0));
