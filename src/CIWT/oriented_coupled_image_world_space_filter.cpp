...
#include "oriented_coupled_image_world_space_filter.h"
...
namespace GOT {
    namespace tracking {
        ...
        // -------------------------------------------------------------------------------
        OrientedCoupledImageWorldSpaceFilter::OrientedCoupledImageWorldSpaceFilter(const Parameters &params)
                : params_(params), CoupledExtendedKalmanFilter(static_cast<KalmanFilter::Parameters>(params)) {

        }

        void OrientedCoupledImageWorldSpaceFilter::Init(const Eigen::VectorXd &x_0, const Eigen::MatrixXd &P_0) {
            // Set params
        ...
        Eigen::Vector4d OrientedCoupledImageWorldSpaceFilter::GetBoundingBox2d() const {
            return this->x_.block(7, 0, 4, 1);
        }

        Eigen::Vector2d OrientedCoupledImageWorldSpaceFilter::GetBoundingBox2dVelocity() const {
            return this->x_.block(12, 0, 2, 1);
        }

        Eigen::Vector3d OrientedCoupledImageWorldSpaceFilter::GetSize3d() const {
            return this->x_.block(4, 0, 3, 1);
        }

        Eigen::Vector2d OrientedCoupledImageWorldSpaceFilter::GetPoseGroundPlane() const {
            return this->x_.head<2>();
        }

        Eigen::Vector2d OrientedCoupledImageWorldSpaceFilter::GetVelocityGroundPlane() const {
            return this->x_.block(2, 0, 2, 1);
        }

        Eigen::Matrix2d OrientedCoupledImageWorldSpaceFilter::GetPoseCovariance() const {
            return P_.block(0, 0, 2, 2);
        }

        Eigen::Matrix3d OrientedCoupledImageWorldSpaceFilter::GetSizeCovariance() const {
            return P_.block(4, 4, 3, 3);
        }

        Eigen::Matrix2d OrientedCoupledImageWorldSpaceFilter::GetVelocityCovariance() const {
            return P_.block(2, 2, 2, 2);
        }

        Eigen::Matrix4d OrientedCoupledImageWorldSpaceFilter::GetBoundingBox2dCovariance() const {
            return P_.block(7, 7, 4, 4);
        }
        double OrientedCoupledImageWorldSpaceFilter::GetRotationY() const{
            return this->x_(11);
        }
        void OrientedCoupledImageWorldSpaceFilter::SetRotationY(double rotationY){
            this->x_(11) = rotationY;
        }
        Eigen::VectorXd OrientedCoupledImageWorldSpaceFilter::NonlinearStateProjection() const {
        ...
        Eigen::MatrixXd OrientedCoupledImageWorldSpaceFilter::LinearizeTransitionMatrix() const {
        ...
        Eigen::VectorXd OrientedCoupledImageWorldSpaceFilter::compute_measurement_residual(const Eigen::VectorXd z_t, const Eigen::MatrixXd &H) {
            return z_t - H*x_;
        }
    }
}