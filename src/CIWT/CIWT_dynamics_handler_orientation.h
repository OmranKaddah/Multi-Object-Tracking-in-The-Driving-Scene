...
#ifndef KALMAN_FILTER_HANDLER_CONST_VELOCITY_H_ORINTATION
#define KALMAN_FILTER_HANDLER_CONST_VELOCITY_H_ORINTATION
...
namespace GOT {
    namespace tracking {
         ...
         */
        class DynamicsHandlerOrientationCIWT : public DynamicsModelHandler {
        public:
            DynamicsHandlerOrientationCIWT(const po::variables_map &params);
        ...
        private:
            ...
            double orientation_variance_obs_;
            ///
            double kf_3d_obs;
            double kf_3d_init;
            double kf_3d_sys; 
