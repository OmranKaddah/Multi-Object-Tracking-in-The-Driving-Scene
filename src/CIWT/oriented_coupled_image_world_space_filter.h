...
#ifndef GOT_KALMAN_FILTER_CONST_VELOCITY_2D_3D_H_ORIENTATION
#define GOT_KALMAN_FILTER_CONST_VELOCITY_2D_3D_H_ORIENTATION
...
namespace GOT {
    namespace tracking {
        ...
        /**
           ...
           */
        class OrientedCoupledImageWorldSpaceFilter : public CoupledExtendedKalmanFilter {
        public:
            ...
            OrientedCoupledImageWorldSpaceFilter(const Parameters &params);
